    ...
    for x in dataset_split_parameter:
        for y in test_column:
            ...
            if len(df_above_zero) > 0 and len(df_zero) > 0:
                ...
                print(f"p-value: {p_val:.10f}, Conclusion: {conclusion}")
...
# Title and labels
plt.title('Scatter Plot of p-values for bat landing number')
...
# Title and labels
plt.title('Scatter Plot of p-values food availability')
plt.xlabel('Test Index')
plt.ylabel('p-value')
plt.xticks(range(12))  # Set x-ticks to match the number of p-values
plt.ylim(0, 1)  # Set y-axis limits
...
# Title and labels
plt.title('Scatter Plot of p-values hours after sunset')
plt.xlabel('Test Index')
plt.ylabel('p-value')
plt.xticks(range(12))  # Set x-ticks to match the number of p-values
plt.ylim(0, 1)  # Set y-axis limits
