...
mean_1 = df_above_zero['hours_after_sunset'].mean()
std_1 = df_above_zero['hours_after_sunset'].std()
n_1 = len(df_above_zero['hours_after_sunset'])

mean_2 = df_zero['hours_after_sunset'].mean()
std_2 = df_zero['hours_after_sunset'].std()
n_2 = len(df_zero['hours_after_sunset'])
...
#%%
z_stats, p_val = ztest(df_above_zero['hours_after_sunset'], df_zero['hours_after_sunset'], alternative='two-sided')
#%%
# print("\n Computing t* ...")
